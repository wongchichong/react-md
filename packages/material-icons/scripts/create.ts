...
function createIconFile(
    ...
    return    `// This is a generated file from running the "createIcons" script. This file should not be updated manually.

import { ${iconType}Icon, ${iconType}IconProps } from "@react-md/icon";

export const ${componentName}${iconType}Icon = ({ref, ...props}: ${iconType}IconProps<${element}>) => {
