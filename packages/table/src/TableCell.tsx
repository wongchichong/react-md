...
export type TableCellAttributes<T extends EventTarget = HTMLTableCellElement> = Omit<
    | TdHTMLAttributes<T>
    | ThHTMLAttributes<T>,
    "colSpan" | "scope"
>
...
export interface TableCellOptions extends TableCellConfig {
     ...
     * equal-sized width.
     */
    grow?: FunctionMaybe<Nullable<boolean>>
     ...
     */
    scope?: FunctionMaybe<Nullable<"row" | "col" | "rowgroup" | "colgroup">>
     ...
     */
    colSpan?: FunctionMaybe<Nullable<number | "100%">>
     ...
     */
    sticky?: FunctionMaybe<Nullable<boolean | "header" | "cell" | "header-cell">>
}

export interface TableCellProps<T extends EventTarget = HTMLTableCellElement> extends TableCellAttributes<T>, TableCellOptions {
    /**
     ...
     */
    "aria-sort"?: FunctionMaybe<Nullable<SortOrder>>
     ...
     * instead of before.
     */
    sortIconAfter?: FunctionMaybe<Nullable<boolean>>
     ...
     */
    sortIconRotated?: FunctionMaybe<Nullable<boolean>>
