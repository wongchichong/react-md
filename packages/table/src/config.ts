...
export interface TableCellConfiguration {
     ...
     */
    lineWrap?: FunctionMaybe<Nullable<boolean>> | "padded"
}
...
export interface TableCellConfig extends TableCellConfiguration {
     ...
     * @internal
     */
    header?: FunctionMaybe<Nullable<boolean>>
}
