...
export interface AutoCompleteProps //<T = AutoCompleteProps>
    extends Omit<TextFieldProps, "type" | "data">,
     ...
     * @see AutoCompletion
     */
    autoComplete?: FunctionMaybe<Nullable<AutoCompletion>>
     ...
     * behavior.
     */
    clearOnAutoComplete?: FunctionMaybe<Nullable<boolean>>
     ...
     * appear.
     */
    disableShowOnFocus?: FunctionMaybe<Nullable<boolean>>

    /**
     * The list of data that should be autocompleted based on the provided filter.
     */
    data: FunctionMaybe<readonly AutoCompleteData[]>
     ...
     */
    filterOptions?: FunctionMaybe<Nullable<FilterFunctionOptions>>
     ...
     */
    filterOnNoValue?: FunctionMaybe<Nullable<boolean>>

    /**
     * An optional className to also apply to the listbox element showing all the
     * matches.
     */
    listboxClassName?: FunctionMaybe<Nullable<string>>
   ...
   */className?: Class
     ...
     *```
     */
    omitKeys?: FunctionMaybe<Nullable<readonly string[]>>
