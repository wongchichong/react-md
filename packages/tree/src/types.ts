...
export interface BaseTreeItem extends TreeItemIds, ListItemChildrenProps {
     ...
     */
    isCustom?: FunctionMaybe<Nullable<boolean>>
}
...
export interface TreeItemExpansionIcon {
     ...
     * `leftAddon` Childverridden instead.
     */
    expanderIcon?: Child
     ...
     * right.
     */
    expanderLeft?: FunctionMaybe<Nullable<boolean>>
}
...
export interface TreeItemExpansion {
     ...
     * `expandedIds`.
     */
    onMultiItemExpansion: Observable<ExpandedIds>
}
...
export interface TreeItemSelection {
     ...
     */
    multiSelect?: FunctionMaybe<Nullable<boolean>>
     ...
     */
    selectedIds: FunctionMaybe<SelectedIds>
...
export interface TreeItemProps<T extends EventTarget = HTMLLIElement>
    extends Omit<HTMLAttributes<HTMLLIElement>, 'selected'>,
    TreeItemStates,
     ...
     * component or in a compChildt has the `role="group"` for accessibility.
     */
    renderChildItems?: Child
     ...
     * element.
     */
    liStyle?: FunctionMaybe<Nullable<string | StyleProperties>>
     ...
     * instead.
     */
    isLink?: FunctionMaybe<Nullable<boolean>>
...
export interface ProvidedTreeItemProps
     ...
     * enabled on the item.
     */
    liRef?: ObservableMaybe<HTMLLIElement | null>
...
export interface TreeProps<T extends BaseTreeItem = UnknownTreeItem>
     ...
     */
    rootId?: FunctionMaybe<Nullable<null | TreeItemId>>
     ...
     */
    labelKey?: FunctionMaybe<Nullable<string>>
     ...
     */
    valueKey?: FunctionMaybe<Nullable<string>>

    /**
     * A function to extract the renderable label from each tree item. The default
     * behavior will be to just return `item[labelChild
     */
    getItemLabel?: (item: T, labelKey: string) => Child
