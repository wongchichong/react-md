 ...
 */
export const Tree = ( // eslint-disable-line @typescript-eslint/no-explicit-any
    {
        id,
        className,
        ...
        ref,
        ...props
    }: TreeProps //<ListElement>
) => {
    // const selectedIds = $$(si)
    ...
    const renderChildItems = (
        ...
        return items.map((item, index) => {
            ...
            let id = ""
            let ref: ObservableMaybe<HTMLLIElement | null> | undefined
            let visibleIndex = -1
            if (!isCustom) {
            ...
            return itemRenderer(
                ...
                { ...item, visibleIndex },
                {
                    id,
                    expanderLeft,
                    expanderIcon: expanderIcon as Child,
                    multiSelect,
                    labelKey,
                    valueKey,
                    getItemLabel,
