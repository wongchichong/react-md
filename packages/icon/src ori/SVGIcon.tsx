...
export interface SVGIconProps extends JSX.HTMLAttributes<SVGSVGElement> {
  /**
...
export const SVGIcon = (function SVGIcon(
  {
    ...
    ref,
    ...props
  }: SVGIconProps & { "aria-hidden"?: boolean }) {
  ...
  return (
    <svg
      ...
      ref={ref}
      className={cn(block({ svg: true, dense }) as any, className)}
      focusable={focusable}
      xmlns={xmlns}
      viewBox={viewBox}
    >
