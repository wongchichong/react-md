...
export default function LoremIpsum(): Child {
    return (
        <TextContainer>
            <Typography>
                ...
                Integer id dui velit. Nulla nisi eros, porttitor id ligula id, hendrerit
                maximus mauris. Sed feugiat lacinia euismod. Mauris eros lectus,
                ultrices et arcu in, finibus ornare neque. Proin rhoncus molestie
                sagittis. Cras sit amet magna sed erat scelerisque auctor. Mauris
                iaculis erat non mi mollis, eget feugiat odio lacinia. Aliquam dapibus
            ...
            <Typography>
                ...
                sit amet metus. Praesent ipsum ante, consequat at velit vel, dapibus
                condimentum purus. Lorem ipsum dolor sit amet, consectetur adipiscing
                elit. Maecenas porttitor sapien non ante ultrices, et posuere mi
                pellentesque. Nunc sollicitudin, tellus vel auctor interdum, tortor nisl
                rutrum ligula, vitae consectetur lacus metus non quam. Aliquam quis
                purus eu ipsum vulputate pellentesque ac nec ipsum. Nunc consequat leo
                ac nunc scelerisque, a fermentum sapien placerat. Morbi commodo non
            ...
            <Typography>
                ...
                Phasellus et mauris enim. Donec volutpat ligula id ex placerat, a
                feugiat tellus lobortis. Integer interdum varius suscipit. Aenean
                rhoncus venenatis enim sed finibus. Sed id blandit mi, eget gravida
                velit. Pellentesque dignissim varius elit, vitae faucibus neque aliquet
            ...
            <Typography>
                ...
                elementum. Integer dignissim, felis ac rhoncus fermentum, ex massa
                tempor dolor, sit amet vestibulum erat massa in dui. Nam egestas, lorem
                in interdum viverra, quam augue tempor turpis, ut accumsan ante urna ut
