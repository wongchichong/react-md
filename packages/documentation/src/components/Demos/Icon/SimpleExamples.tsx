    ...
    return (
        <>
            <span className={styles.container}>
                ...
                <Typography>Home font icon from material-icons</Typography>
            </span>
            <span className={styles.container}>
                <FontIcon
                    aria-label="Github"
                ...
                />
                <Typography>Github icon from font awesome</Typography>
            </span>
            <span className={styles.container}>
                ...
                <Typography>Custom Github SVG Icon</Typography>
            </span>
        </>
    )
}
