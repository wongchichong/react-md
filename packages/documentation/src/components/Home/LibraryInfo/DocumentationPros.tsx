...
export default function DocumentationPros(): ReactElement | null {
  return (
    <TableCellList>
      <li>
        All components, hooks, and utility functions are written and maintained
        in <Link href="https://typescriptlang.org">Typescript</Link>.
      </li>
      <li>
      ...
      <li>
        Multiple demos, common patterns, and use cases provided for each
        package.
      </li>
    </TableCellList>
  );
