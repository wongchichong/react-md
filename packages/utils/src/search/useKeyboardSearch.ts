...
> extends BaseSearchOptions<D> {
     ...
     */
    onKeyDown?: JSX.KeyboardEventHandler<E>
     ...
     */
    resetTime?: FunctionMaybe<Nullable<number>>
...
> extends BaseKeyboardSearchOptions<D, E> {
     ...
     */
    searchIndex: FunctionMaybe<number>
}

type ReturnValue<E extends HTMLElement = HTMLElement> =
    JSX.KeyboardEventHandler<E>
...
>({
    ...
    onChange,
    onKeyDown,
    resetTime: rt = DEFAULT_SEARCH_RESET_TIME,
    searchIndex,
    valueKey: vk = DEFAULT_VALUE_KEY,
