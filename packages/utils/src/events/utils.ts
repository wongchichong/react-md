 ...
 * errors trying to do `JSX.TargetedMouseEvent` or `JSX.TargetedKeyboardEvent` in your listeners.
 */
...
function createDelegatedEventHandler(
    ...
    throttle = false,
    options?: FunctionMaybe<Nullable<boolean>> | FunctionMaybe<AddEventListenerOptions>
