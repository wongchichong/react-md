...
export interface AppSize {
     ...
     */
    isLandscape: FunctionMaybe<boolean>
}
...
export interface AppSizeOptions {
     ...
     */
    phoneMaxWidth?: FunctionMaybe<QuerySize>

    /**
     * The min width for a tablet device.
     */
    tabletMinWidth?: FunctionMaybe<QuerySize>
     ...
     */
    tabletMaxWidth?: FunctionMaybe<QuerySize>

    /**
     * The min width for a desktop screen.
     */
    desktopMinWidth?: FunctionMaybe<QuerySize>

    /**
     * The min width for a large desktop screen.
     */
    desktopLargeMinWidth?: FunctionMaybe<QuerySize>
     ...
     */
    defaultSize?: FunctionMaybe<AppSize>
}
...
export function useAppSizeMedia({
    ...
    useEffect(() => {
        ...
        appSize({ isPhone, isTablet, isDesktop, isLargeDesktop, isLandscape })
    })
