 ...
 * @remarks \@since 5.0.0
 */
export function useActiveDescendant<E extends HTMLElement>({ id, ref, }: ActiveDescendantHookOptions<E>): ActiveDescendantHookReturnValue<E> {
