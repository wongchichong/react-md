...
export interface TypographyProps
     ...
     * typography.
     */
    type?: FunctionMaybe<Nullable<TypographyType>>
     ...
     * `component` prop.
     */
    children?: Children | ClassNameCloneableChild | TypographyRenderFunction

    /**
     * An optional text alignment to apply.
     */
    align?: CSSProperties['textAlign'] //FunctionMaybe<Nullable<TextAlign>>
     ...
     */
    color?: FunctionMaybe<Nullable<TextColor>>

    /**
     * An optional text decoration to apply.
     */
    decoration?: CSSProperties['textDecoration'] //TextDecoration

    /**
     * An optional text transformation to apply.
     */
    transform?: CSSProperties['textTransform'] //TextTransform
     ...
     */
    fontStyle?: CSSProperties['fontStyle'] //FontStyle
     ...
     */
    margin?: FunctionMaybe<Nullable<"initial" | "none" | "top" | "bottom">>
}

function getComponent(component: Component | null, type: TypographyType): Component {
    if (component) {
        return component
    }
 ...
 */
export const Typography = /* TypographyHTMLElement */(
    {
