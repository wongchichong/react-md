...
export function MiniLayoutWrapper({
    ...
    containerProps,
    ...props
}: MiniLayoutWrapperProps): Element {
    ...
    return (
        <div
            {...containerProps}
            className={[!miniHidden && mini && styles(), containerProps?.className]}
        >
            {mini && miniNavigation}
            {children}
        </div>
