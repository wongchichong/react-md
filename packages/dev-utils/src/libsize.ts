...
interface Options {
    umd?: FunctionMaybe<Nullable<boolean>>
    forceUmd?: FunctionMaybe<Nullable<boolean>>
    themes?: FunctionMaybe<Nullable<boolean>>
    forceThemes?: FunctionMaybe<Nullable<boolean>>
    stageChanges?: FunctionMaybe<Nullable<boolean>>
}
...
export default function OtherPros(): Element {
  return (
    <TableCellList>
      <li>
