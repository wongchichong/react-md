...
function removeDocSpecific(markdown: string, filePath?: FunctionMaybe<Nullable<string>>): string {
...
export async function copyMarkdown(src: string, dest: string): Promise<void> {
