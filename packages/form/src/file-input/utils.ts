...
export class FileAccessError extends Error {
   ...
   */
  constructor(message?: FunctionMaybe<Nullable<string>>) {
    super($$(message))
    this.key = nanoid()
...
export class GenericFileError extends Error {
   ...
   */
  constructor(public files: readonly File[], public reason?: FunctionMaybe<Nullable<string>>) {
    super("Invalid files")
    this.key = nanoid()
 ...
 * @remarks \@since 3.1.0
 */
export type IsValidFileName = (file: File, extensionRegExp: RegExp | undefined, extensions: readonly string[]) => boolean
...
export interface FileValidationOptions {
   ...
   * @defaultValue `-1`
   */
  maxFiles?: FunctionMaybe<Nullable<number>>
   ...
   * @defaultValue `-1`
   */
  minFileSize?: FunctionMaybe<Nullable<number>>
   ...
   * @defaultValue `-1`
   */
  maxFileSize?: FunctionMaybe<Nullable<number>>
   ...
   * ```
   */
  extensions?: FunctionMaybe<Nullable<readonly string[]>>
   ...
   * @defaultValue `-1`
   */
  totalFileSize?: FunctionMaybe<Nullable<number>>
}
...
export function validateFiles<CustomError>(
  ...
  const extensions = $$(ex), maxFiles = $$(mf), minFileSize = $$(mnfs), maxFileSize = $$(mxfs), totalBytes = $$(tb), totalFiles = $$(tf), totalFileSize = $$(tfs)
