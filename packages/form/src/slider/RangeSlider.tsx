 ...
 * @remarks \@since 2.5.0
 */
export interface RangeSliderProps<T extends EventTarget>
  extends RangeSliderRequiredProps,
  Omit<BaseSliderProps<T>, 'min' | 'max' | 'step' | 'value'> {
  /**
   ...
   * a11y.
   */
  thumb1Label?: FunctionMaybe<Nullable<string>>
   ...
   */
  thumb1LabelledBy?: FunctionMaybe<Nullable<string>>
   ...
   */
  thumb2Label?: FunctionMaybe<Nullable<string>>
   ...
   * `thumb2Props` for a11y.
   */
  thumb2LabelledBy?: FunctionMaybe<Nullable<string>>
}
...
export const RangeSlider = (
  {
    ...
    ref,
    ...props
  }: RangeSliderProps<HTMLSpanElement>
) => {
  const {
    thumb1Ref,
    thumb1Value,
  ...
  const thumb1KeyDown = (event: TargetedKeyboardEvent<HTMLSpanElement>) => {
  ...
  const thumb2KeyDown = (event: TargetedKeyboardEvent<HTMLSpanElement>) => {
