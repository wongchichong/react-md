...
export interface SliderControls {
  persist(): void
  minimum(value?: number): void
  maximum(value?: number): void
  increment(value?: number): void
  incrementJump(value?: number): void
  decrement(value?: number): void
  decrementJump(value?: number): void
...
export interface SliderStepOptions extends SliderValueOptions {
   ...
   * the nearest step
   */
  jump?: FunctionMaybe<Nullable<number>>
   ...
   * be used immediately.
   */
  updateOn?: FunctionMaybe<Nullable<"change" | "blur">>
}
...
export interface SliderThumbPresentation {
   ...
   * the slider.
   */
  discrete?: FunctionMaybe<Nullable<boolean>>
 ...
 */
//@ts-ignore
export interface BaseSliderProps<T extends EventTarget>
