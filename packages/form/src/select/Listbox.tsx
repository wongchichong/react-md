...
export interface ListboxOptions extends RenderConditionalPortalProps {
     ...
     */
    disableMovementChange?: FunctionMaybe<Nullable<boolean>>
}
...
export interface ListboxProps
     ...
     */
    visible?: FunctionMaybe<Nullable<boolean>>
...
export const Listbox = (
    ...
    const handleKeyboardClick = (focusedIndex: number) => {
    ...
    const handleFocus = (event: JSX.TargetedFocusEvent<ListElement>) => {
        ...
        const item = itemRefs[focusedIndex()] && itemRefs[focusedIndex()]()
        if (item) {
            scrollIntoView(event.currentTarget as any, item)
        }
    }
    ...
    const { elementProps, rendered } = useScaleTransition({
        ...
        nodeRef,
        timeout,
        className: [block({ temporary }), propClassName],
        classNames,
